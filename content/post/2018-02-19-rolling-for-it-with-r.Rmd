...
I find it easiest to work with a vector of values and thus prefer the map_* approach.

For example, now it's trivial to visualize the distribution of 1,000 rolls of 6 dice with a target value of 4:
